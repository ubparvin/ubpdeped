	...
	<div class="row">	
		...
		<div class="col-md-3">
			<div class="fs-22 text-center">TXT</div>
			<div class="row">
				<div class="col-md-6">
					<div class="fs-16 text-center">ESP</div>
					<div class="fs-22 text-center"><?php echo $couriertxtitem->esp_tx; ?></div>
				</div>
				<div class="col-md-6">
					<div class="fs-16 text-center">AP</div>
					<div class="fs-22 text-center"><?php echo $couriertxtitem->ap_tx; ?></div>
				</div>
			</div>
		</div>
		<div class="col-md-3">
			<div class="fs-22 text-center">TM</div>
			<div class="row">
				<div class="col-md-6">
					<div class="fs-16 text-center">ESP</div>
					<div class="fs-22 text-center"><?php echo $couriertxtitem->esp_tm; ?></div>
				</div>
				<div class="col-md-6">
					<div class="fs-16 text-center">AP</div>
					<div class="fs-22 text-center"><?php echo $couriertxtitem->ap_tm; ?></div>
				</div>
			</div>
		</div>

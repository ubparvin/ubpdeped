<div class="row">
	<div class="col-lg-12 col-md-12">
				...
				<div class="text-left">
                    <span class="small text-info bold fs-11">WAREHOUSE INFORMATION</span>
                </div>
					...
					<div class="row">
						<div class="col-md-12">
						 <?php echo $this->Form->control('name', 
							...
							<div class="text-warning fs-10">Note: Could be a region name</div>
						</div>
					...
					<div class="row">
						...
						<div class="col-md-12">
							<?php echo $this->Form->control('sitio', 
								['label' => 'Sub Division / Lot No. / Street Name ', 
								'rows' => 2,
				...
				<?= $this->Form->button(__('Create'), [
					...
					'id'	=> 'btnsubmit',
					'action' => 'new',
					'url'	=> $this->Url->build(['controller' => 'warehouses', 'action' => 'editajax', $id]),

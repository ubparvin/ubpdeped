<div class="row">
	<div class="col-lg-12 col-md-12">
				...
				<div class="text-left">
                    <span class="small text-info bold fs-11">SCHOOL INFORMATION</span>
                </div>
					...
					<div class="row">
						...
						<div class="col-md-3 nopadding-left">
						 <?php echo $this->Form->control('tel_no', 
							['label' => 'Tel. No. <span class="m-l-2 text-info">*</span>', 
				...
				<div class="text-left">
                    <span class="small text-info bold fs-11">CURRENT ADDRESS</span>
                </div>
				
				<div class="form-group">
					<div class="row">
						<div class="col-md-12">
							<span class="fs-12 bold text-warning"><?php echo $school->address; ?></span>
						</div>
						
						<div class="col-md-6 nopadding-right">
						
						 <?php echo $this->Form->control('regCode', 
							['label' => 'New Region <span class="m-l-2 text-info">*</span>', 
							'empty' => '--Choose',
				...
				<?= $this->Form->button(__('Save Changes'), [
					...
					'id'	=> 'btnsubmit',
					'action' => 'update',
					'url'	=> $this->Url->build(['controller' => 'schools', 'action' => 'editajax', $id]),

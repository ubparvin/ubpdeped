<div class="row">
	<div class="col-lg-12 col-md-12">
					...
					<div class="row">
						<div class="col-md-12">
						 <?php echo $this->Form->control('name', 
							...
							'escape' => false, 
							'class' => 'noradius allcaps form-control']
						); ?>
						</div>
				...
				<div class="text-left">
                    <span class="small text-danger bold fs-11">CURRENT ADDRESS</span>
                </div>
				
				<div class="form-group">
					<div class="row">
						<div class="col-md-12">
							<span class="fs-12 bold text-warning"><?php echo $office->address; ?></span>
						</div>
						<div class="col-md-6 nopadding-right">
						
						 <?php echo $this->Form->control('regCode_1', 
							['label' => 'New Region <span class="m-l-2 text-danger">*</span>', 
							'empty' => '--Choose',
				...
				<?= $this->Form->button(__('Save Changes'), [
					...
					'id'	=> 'btnsubmit',
					'action' => 'update',
					'url'	=> $this->Url->build(['controller' => 'offices', 'action' => 'editajax', $id]),

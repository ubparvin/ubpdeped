<div class="col-md-12">
	<div class="row">
			<div class="col-md-10 text-warning bold"><?php echo $school->name; ?></div>
			<div class="col-md-2 text-right fs-11 bold"><?php echo $school->status; ?></div>
	</div>
					...
					<div class="row">
						<div class="col-md-4 nopadding">
							...
							<div class="fs-14 bold text-default">
								<?php echo $school->contact_person; ?>
							</div>
						</div>
						<div class="col-md-4 nopadding">
							<div class="fs-9 bold text-success">CONTACT NO.</div>
							<div class="fs-14 bold text-default">
								<?php echo $school->mobile_no; ?> / <?php echo $school->tel_no; ?>
							</div>
						</div>
						<div class="col-md-4 nopadding">
				...
				<li class="list-group-item">
					<div class="row">
						<div class="col-md-6 nopadding">
							...
							<div class="fs-14 bold text-default">
								<?php echo $school->added; ?>
								<div class="fs-9 bold text-warning"><?php echo $school->added_by; ?></div>
							</div>
						</div>
						<div class="col-md-6 nopadding">
							<div class="fs-9 bold text-success">UPDATE</div>
							<div class="fs-14 bold text-default">
								<?php echo $school->modified; ?> 
								<div class="fs-9 bold text-warning"><?php echo $school->modified_by; ?></div>
							</div>
						</div>

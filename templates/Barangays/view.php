            ...
            <div class="related">
                ...
                <div class="table-responsive">
                    <table>
                        ...
                        <?php foreach ($barangay->offices as $offices) : ?>
                        <tr>
                            <td><?= h($offices->id) ?></td>
            ...
            <div class="related">
                ...
                <div class="table-responsive">
                    <table>
                        ...
                        <?php foreach ($barangay->schools as $schools) : ?>
                        <tr>
                            <td><?= h($schools->id) ?></td>
            ...
            <div class="related">
                ...
                <div class="table-responsive">
                    <table>
                        ...
                        <?php foreach ($barangay->users as $users) : ?>
                        <tr>
                            <td><?= h($users->id) ?></td>
            ...
            <div class="related">
                ...
                <div class="table-responsive">
                    <table>
                        ...
                        <?php foreach ($barangay->vendors as $vendors) : ?>
                        <tr>
                            <td><?= h($vendors->id) ?></td>

...
<?php 
	...
	echo $this->Html->script('table/purchase_table', ['block' => 'scriptBottom']);	
	echo $this->Html->script('admin/controller/purchase', ['block' => 'scriptBottom']);	
	echo $this->Html->scriptStart(['block' => 'scriptBottom']);
		echo 'showIndexTable("#p_table", getTheWebroot()  + "purchases/indexajax")';

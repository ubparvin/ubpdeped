<div class="row">
	<div class="col-lg-12 col-md-12 m-b-20">
				...
				<div class="text-left">
                    <span class="small text-info bold fs-11">STATUS</span>
					...
					<div class="row">
						<div class="col-md-3">
							 <?php echo $this->Form->control('status', 
								['label' => 'Account <span class="m-l-2 text-info">*</span>', 
								'options' => array("ACTIVE" => "ACTIVE", "INACTIVE" => "PENDING", "BLOCKED" => "BLOCKED"),
						...
						<div class="col-md-3 nopadding-right">
							...
							<div><?php echo (!empty($user->last_access) ? $user->last_access : "--"); ?></div>
						</div>
						<div class="col-md-3 nopadding-left">
							<label>Account Created</label>
							<div><?php echo $user->added; ?></div>
							<div class="text-warning fs-10"><?php echo $user->added_by; ?></div>
						</div>
						<div class="col-md-3 nopadding-left">
							<label>Account Modified</label>
							<div><?php echo $user->modified; ?></div>
							<div class="text-warning fs-10"><?php echo $user->modified_by; ?></div>
						</div>
					</div>
				</div>
				...
				<?= $this->Form->button(__('Save Changes'), [
					...
					'id'	=> 'btnsubmit',
					'action' => 'update',
					'url'	=> $this->Url->build(['controller' => 'users', 'action' => 'editajax', $id]),

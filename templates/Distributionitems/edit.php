...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $distributionitem->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $distributionitem->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="distributionitems form content">
            ...
            <fieldset>
                <legend><?= __('Edit Distributionitem') ?></legend>
                <?php

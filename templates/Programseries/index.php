...
<div class="programs index content">
		<div class="btn-group">
			...
			['action' => 'add', 'controller' => 'programseries'], 
			['escape' => false, 'class' => 'nooutline fs-11 bold btn btn-success btn-sm modal_view_sub noradius', 
		...
		<?php echo $this->Form->create(); ?>
		   <table class="table table-condensed table-striped" id="programseries_table" width="100%" cellspacing="0">
				<thead>
					<tr>
						<th>ID</th>
						<th>NAME</th>

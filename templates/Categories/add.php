	...
	<div class="col-lg-12 col-md-12">
				...
				<div class="text-left">
                    <span class="small text-danger bold fs-11">CATEGORY INFORMATION</span>
                </div>
				<div class="form-group">
					<div class="row">
						<div class="col-md-12">
						 <?php echo $this->Form->control('name', 
							['label' => 'Category Name <span class="m-l-2 text-danger">*</span>', 
				...
				<?= $this->Form->button(__('Create'), [
					...
					'id'	=> 'btnsettings',
					'action' => 'new',
					'url'	=> $this->Url->build(['controller' => 'categories', 'action' => 'saveajax']),
